namespace MycoKeyCreator.Library.PetaPocoAdapter
{
    public class PostgreSQLServerDatabaseFactory
    {
        ...
        public static void OpenDatabase(out MycoKeyCreator.Library.Database.IDatabase iDatabase, string host, int port, bool useWindowsAuthentication, string userName, string password, string dbName)
        {
