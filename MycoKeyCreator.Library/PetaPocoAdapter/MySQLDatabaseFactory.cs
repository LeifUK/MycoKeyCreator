...
namespace MycoKeyCreator.Library.PetaPocoAdapter
{
    public class MySQLDatabaseFactory
    {
        ...
        public static void OpenDatabase(out MycoKeyCreator.Library.Database.IDatabase iDatabase, string server, int port, bool useWindowsAuthentication, string userName, string password, string dbName)
        {
