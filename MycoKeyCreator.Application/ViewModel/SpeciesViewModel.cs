...
namespace MycoKeyCreator.Application.ViewModel
{
    public class SpeciesViewModel :  OpenControls.Wpf.Utilities.ViewModel.BaseViewModel
    {
        ...
        private readonly MycoKeyCreator.Library.Database.IKeyManager _iKeyManager;
        private readonly MycoKeyCreator.Library.DBObject.Key _key;
        ...
        public readonly MycoKeyCreator.Library.DBObject.Species EditedSpecies;
        public readonly MycoKeyCreator.Library.DBObject.Species Species;
