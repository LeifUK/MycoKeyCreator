...
namespace MycoKeyCreator.Application.View
{
    ...
    public partial class KeyView : Window
    {
        ...
        {
            EditSpecies((DataContext as MycoKeyCreator.Application.ViewModel.KeyViewModel).SelectedSpecies);
        }
        ...
        private void _buttonDeleteSpecies_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                (DataContext as MycoKeyCreator.Application.ViewModel.KeyViewModel).DeleteSelectedSpecies();
            }
        }
        ...
        private void _buttonDeleteAttribute_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                (DataContext as MycoKeyCreator.Application.ViewModel.KeyViewModel).DeleteSelectedAttribute();
            }
        }
        ...
        {
            (DataContext as MycoKeyCreator.Application.ViewModel.KeyViewModel).MoveSelectedAttributeUp();
        }

        private void _buttonMoveAttributeDown_Click(object sender, RoutedEventArgs e)
        {
            (DataContext as MycoKeyCreator.Application.ViewModel.KeyViewModel).MoveSelectedAttributeDown();
        }
